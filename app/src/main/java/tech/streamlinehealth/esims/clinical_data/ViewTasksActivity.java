    ...
    private void fetchTasks() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(url,
                response -> {
                    ...
                    TaskAdapter mAdapter = new TaskAdapter(ViewTasksActivity.this, tasks, false);

                    RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(ViewTasksActivity.this);
